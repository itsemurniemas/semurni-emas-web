...
const CatalogInfo = ({ catalog, categoryLabel }: CatalogInfoProps) => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-3 pt-4">
        <Link
          href="/branches"
          className="inline-block w-full h-12 bg-foreground text-background font-light rounded-none hover:bg-foreground/90 transition-colors text-center leading-12"
        >
          Hubungi Kami
        </Link>
      </div>
