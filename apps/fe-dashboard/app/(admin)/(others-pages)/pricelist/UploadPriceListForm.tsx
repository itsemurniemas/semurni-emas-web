...
interface UploadPriceListFormProps {
  open: boolean;
  setOpen: (open: boolean) => void;
  onUpload?: (file: File) => void;
}

const UploadPriceListForm: React.FC<UploadPriceListFormProps> = ({
  open,
  setOpen,
  onUpload,
}) => {
    ...
    return (
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="sm:max-w-106.25">
          <DialogHeader>
            <DialogTitle>Upload Pricelist XLSX</DialogTitle>
            <DialogDescription>
              Pilih file XLSX untuk mengupload data pricelist logam mulia.
            </DialogDescription>
          </DialogHeader>
          {formContent}
          <DialogFooter>
      ...
      <DrawerContent>
        <div className="mx-auto w-full max-w-sm">
          <DrawerHeader className="text-left">
            <DrawerTitle>Upload Pricelist XLSX</DrawerTitle>
            <DrawerDescription>
              Pilih file XLSX untuk mengupload data pricelist logam mulia.
            </DrawerDescription>
          </DrawerHeader>
...
export default UploadPriceListForm;
