...
const BuyBranchSelectionStep: React.FC<BranchSelectionStepProps> = ({
  selected,
  branchListState,
  onSelect,
  isSuperAdmin,
      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
            Pilih cabang untuk transaksi pembelian ini. Semua item akan dicatat
        ...
        {selected && (
          <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-4">
            <p className="text-sm font-medium text-green-900 dark:text-green-300">
              ...
              {branchOptions.find((b) => b.value === selected)?.label}
            </p>
          </div>
        )}
      </div>
...
export default BuyBranchSelectionStep;
