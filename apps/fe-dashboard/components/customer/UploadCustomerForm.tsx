...
interface UploadCustomerFormProps {
  open: boolean;
  setOpen: (open: boolean) => void;
  onUpload?: (file: File) => void;
}

const UploadCustomerForm: React.FC<UploadCustomerFormProps> = ({
  open,
  setOpen,
  onUpload,
}) => {
    ...
    return (
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="sm:max-w-106.25">
          <DialogHeader>
            <DialogTitle>Upload Pelanggan XLSX</DialogTitle>
            <DialogDescription>
              Pilih file XLSX untuk mengunggah atau memperbarui data pelanggan.
            </DialogDescription>
          </DialogHeader>
          {formContent}
          <DialogFooter>
      ...
      <DrawerContent>
        <div className="mx-auto w-full max-w-sm">
          <DrawerHeader className="text-left">
            <DrawerTitle>Upload Pelanggan XLSX</DrawerTitle>
            <DrawerDescription>
              Pilih file XLSX untuk mengunggah atau memperbarui data pelanggan.
            </DrawerDescription>
          </DrawerHeader>
