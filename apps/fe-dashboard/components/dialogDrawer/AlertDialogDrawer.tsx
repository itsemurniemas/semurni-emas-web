  ...
  if (isDesktop) {
    return (
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="sm:max-w-106.25 border-0 shadow-lg">
          <DialogHeader className="sr-only">
            <DialogTitle>{title}</DialogTitle>
            <DialogDescription>{description}</DialogDescription>
          </DialogHeader>

          <AlertIcon config={config} />
...
function AlertIcon({ config }: AlertIconProps) {
  return (
...
function getAlertConfig(type: AlertType) {
  switch (type) {
    case "error":
      return {
        bgColor: "fill-error-50 dark:fill-error-500/15",
    ...
    case "success":
      return {
        bgColor: "fill-success-50 dark:fill-success-500/15",
    ...
    case "warning":
      return {
        bgColor: "fill-warning-50 dark:fill-warning-500/15",
        iconColor: "fill-warning-600 dark:fill-warning-500",
    ...
    case "info":
      return {
        bgColor: "fill-blue-light-50 dark:fill-blue-light-500/15",
        iconColor: "fill-primary-600 dark:fill-primary-500",
